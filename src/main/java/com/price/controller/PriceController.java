...
public class PriceController {
	...
	double getPrice(@PathVariable("productId") Integer productId){
		return this.priceservice.getPriceOfProduct(productId);
	}
	
	@GetMapping("/priceList")
	List<Price> getAllProductPrice(){
		return this.priceservice.getAllProductPrice();
	}
}
